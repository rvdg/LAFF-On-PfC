...
\renewcommand{\invariant}{
	...
	\end{array}\right)  = 
	\left(\begin{array}{r}
		A_{TL} x_T + \phantom{A_{BL}^T x_B +} \widehat y_T \\ \whline 
		A_{BL} x_T + \phantom{A_{BL}^T x_B +} \widehat y_B 
	\end{array}\right)
}
...
\renewcommand{\beforeupdate}{$ 
		...
		\end{array}\right)  = 
		\left(\begin{array}{r}
		A_{00} x_0  + \phantom{\chi_1 (a_{10}^T)^T + A_{20}^T x_2 +} \widehat y_0 \\ 
		a_{10}^T x_0 + \phantom{\alpha_{11} \chi_1  + a_{21}^T x_2 +} \widehat \psi_1 \\
		A_{20} x_0 + \phantom{\chi_1 a_{21} + A_{22} x_2 +}  \widehat y_2
		\end{array}\right)
		$}
...
\renewcommand{\afterupdate}{$ 
			...
			\end{array}\right)  = 
			\left(\begin{array}{c}
		A_{00} x_0  + \chi_1 (a_{10}^T)^T +\phantom{ A_{20}^T x_2 +} \widehat y_0 \\ 
		a_{10}^T x_0 + \alpha_{11} \chi_1  +\phantom{ a_{21}^T x_2 +} \widehat \psi_1 \\
		A_{20} x_0 + \chi_1 a_{21} +\phantom{ A_{22} x_2 +}  \widehat y_2
			\end{array}\right)
			$    }
