...
\renewcommand{\beforeupdate}{$
			...
			l_{10}^T & \widehat \alpha_{11} - l_{10}^T u_{01} & \widehat a_{12}^T - l_{10}^T U_{02} \\ 
			L_{20} & \widehat a_{21} - L_{20} u_{01} & \widehat A_{22} - L_{20} U_{02}
			\end{array}\right) \\
			~~~~~~~~\wedge 
			\begin{array}{c c c}
...
\renewcommand{\afterupdate}{$ 
			...
			L_{20} & l_{21} & \widehat A_{22} - L_{20} U_{02} - l_{21} u_{12}^T
			\end{array}\right) \\
			~~~~~~~~~~\wedge 
			\begin{array}{c c c}
			L_{00} U_{00} = \widehat A_{00} & L_{00} u_{01} = \widehat a_{01} 
			...
			l_{10}^T U_{02} + u_{12}^T = \widehat a_{12}^T  \\
			L_{20} U_{00} = \widehat A_{20} & L_{20} u_{01} + \upsilon_{11} l_{21} = \widehat a_{21} 
			\end{array}
	$}
...
\renewcommand{\update}{
	...
	a_{21}^T := u_{21}^T = ( \widehat a_{21} - L_{20} u_{01} ) / \upsilon_{11}
	= a_{21} / \alpha_{11} \\
	A_{22} := \widehat A_{22} - L_{20} U_{02} - l_{21} u_{12}^T =
	A_{22} - a_{21} a_{12}^T
