...
\renewcommand{\invariant}{
	...
	\end{array}\right)  = 
	\left(\begin{array}{r}
		 {\color{white} A_{BL}^T x_B  + } \widehat y_T \\ \whline 
		 {\color{white} A_{BL} x_T +} A_{BR} x_B + \widehat y_B 
	\end{array}\right)
}
...
\renewcommand{\beforeupdate}{$ 
		...
		\end{array}\right)  = 
		\left(\begin{array}{r}
		{\color{white} A_{20}^T x_2  +} \widehat y_0 \\ 
		{\color{white} a_{21}^T x_2 +} \widehat \psi_1 \\
		{\color{white} A_{20} x_0 + \chi_1 a_{21} +} A_{22} x_2 + \widehat y_2 
		\end{array}\right)
		$}
...
\renewcommand{\afterupdate}{$ 
			...
			\end{array}\right)  = 
			\left(\begin{array}{r}
			{\color{white} \chi_1 (a_{10}^T)^T + A_{20}^T x_2  +} \widehat y_0 \\ 
			{\color{white} a_{10}^T x_0 +} \alpha_{11} \chi_1 + a_{21}^T x_2 + \widehat \psi_1 \\
			{\color{white} A_{20} x_0 +} \chi_1 a_{21} + A_{22} x_2 + \widehat y_2 
			\end{array}\right)
			$}
...
\renewcommand{\update}{
	...
	y_2 &:=& a_{21} \chi_1 + {\color{white} A_{22} x_2 +} y_2 \\
