...
\renewcommand{\operation}{ A := x y^T + A }
...
\renewcommand{\invariant}{
	...
	\end{array}\right)  = 
	\left(\begin{array}{c I c}
		\widehat A_L   & x y_B^T + \widehat A_R
	\end{array}\right)
}
...
\renewcommand{\beforeupdate}{$ 
		...
		\end{array}\right)  = 
		\left(\begin{array}{c c c}
		\widehat A_0   & \widehat a_1 & x y_2^T + \widehat A_2
		\end{array}\right)
		$}
...
\renewcommand{\afterupdate}{$ 
			...
			\end{array}\right)  = 
			\left(\begin{array}{c c c}
			\widehat A_0   & \psi_1 x +  \widehat a_1 & x y_2^T + \widehat A_2
			\end{array}\right)
			$}
