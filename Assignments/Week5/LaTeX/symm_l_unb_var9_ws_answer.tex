...
\renewcommand{\invariant}{
	...
	\end{array}\right)  = 
	\left(\begin{array}{c I c}
		A B_L + \widehat C_L   & {\color{white} A B_R +} \widehat C_R
	\end{array}\right)
}
...
\renewcommand{\beforeupdate}{$
	...
	\end{array}\right)  = 
	\left(\begin{array}{c c c}
	A B_0 + \widehat C_0   & {\color{white} A b_1 +} \widehat c_1 & {\color{white} A B_2 +} \widehat C_2
	\end{array}\right)
	 $}
...
\renewcommand{\afterupdate}{$ 
		...
		\end{array}\right)  = 
		\left(\begin{array}{c c c}
		A B_0 + \widehat C_0   & A b_1 + \widehat c_1 & {\color{white} A B_2 +} \widehat C_2
		\end{array}\right)
	$}
