...
\renewcommand{\operation}{ \left[ \alpha \right] := \mbox{\sc sapdot\_unb\_var1}( x, y, \alpha ) }
...
\renewcommand{\afterupdate}{
	$\alpha = x_0^T y_0 + \chi_1 \times \psi_1 + \widehat \alpha$
}
...
\renewcommand{\update}{
	...
	\alpha := \chi_1 \times \psi_1 + \widehat \alpha
