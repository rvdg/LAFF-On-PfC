...
\renewcommand{\beforeupdate}{$ 
			...
			a_{10}^T x_0 + {\color{white} \alpha_{11} \chi_1 + a_{21}^T x_2 +} \widehat \psi_1 \\
			A_{20} x_0 + {\color{white} \chi_1 a_{21} +}
			{\color{white} A_{22} x_2 + } \widehat y_2
			\end{array}\right)
		$}
