...
\renewcommand{\beforeupdate}{$
		...
		\end{array}\right)  = 
		\left(\begin{array}{r}
		A_{00} B_0 + (a_{10}^T)^T b_1^T + A_{20}^T B_2 + \widehat C_0 \\ 
...
\renewcommand{\afterupdate}{$ 
	 ...
	 \left(\begin{array}{r}
	 A_{00} B_0 + (a_{10}^T)^T b_1^T + A_{20}^T B_2 + \widehat C_0 \\ 
	 a_{10}^T B_0 + \alpha_{11} b_1^T + a_{21}^T B_2 + \widehat c_1^T \\ 
	 {\color{white} A_{20} B_0 + a_{21} b_1^T + A_{22} B_2 + \widehat C_2} 
	 \end{array}\right)
	 $}
...
\renewcommand{\update}{
	...
	{\color{white} C_0 := A_{00} B_0 + a_{01} b_1^T + A_{02} B_2 + C_0} \\ 
	c_1^T := a_{10}^T B_0 + \alpha_{11} b_1^T + a_{21}^T B_2 + c_1^T \\ 
