...
\renewcommand{\update}{
	...
	\alpha_{11} := \upsilon_{11} = \widehat \alpha_{11} - l_{10}^T u_{01} = 
	\alpha_{11} - a_{10}^T a_{01} \\
	a_{12}^T := u_{12}^T = \widehat a_{12}^T - l_{10}^T U_{02} =	
	a_{12}^T - a_{10}^T A_{02} \\
	a_{21}^T := u_{21}^T = ( \widehat a_{21} - L_{20} u_{01} ) / \upsilon_{11}
	= ( a_{21} - A_{20} a_{01} ) / \alpha_{11}
